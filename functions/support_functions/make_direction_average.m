...
for i=1:numel(bunique)
    ...
    elseif i>1
            ...
            disp(['   - Calculating powder average signal by estimating the zero-order SH - shell ' num2str(i-1) ' of ' num2str(numel(bunique)-1) ' ; #directions = ' num2str(sum(bvals==bunique(i)))])
