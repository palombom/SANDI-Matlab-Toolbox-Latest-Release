...
for subj_id = 1:numel(SubList)
    ...
    for ses_id = 1:numel(SesList)
        ...
        if ~isempty(noisemap_mppca_filename)
            ...
            SANDIinput.noisemap_mppca_filename = [];
        end
        ...
        SANDIinput = make_direction_average(SANDIinput); % Calculate the spherical mean or direction average and estimate noise distributions
    end
end
end