function [] = run_model_fitting_with_dot_forGUI(SANDIinput,fig_axes)
...
names = {'fneurite', 'fsoma', 'Din', 'Rsoma', 'De', 'fdot', 'fextra', 'Rsoma_Low_fsoma_Filtered', 'Din_Low_fsoma_Filtered'};
bounds = [0 0.7; 0 0.7; model.paramsrange(3:6,:).*1; 0 1];
